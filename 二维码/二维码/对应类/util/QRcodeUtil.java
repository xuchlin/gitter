...
public class QRcodeUtil {
     ...
     * @throws IOException 
     */  
    public static BufferedImage qrCodeEncode(String encodeddata) throws IOException {  
     ...
     * @throws IOException 
     */  
    public static void qrCodeEncode(String encodeddata, HttpServletResponse response) throws IOException {  
        Qrcode qrcode = new Qrcode();  
        qrcode.setQrcodeErrorCorrect('M');  // 纠错级别（L 7%、M 15%、Q 25%、H 30%）和版本有关  
        qrcode.setQrcodeEncodeMode('B');      
        qrcode.setQrcodeVersion(7);     // 设置Qrcode包的版本  
